  ...
  return (
    <div className="ml-10 mr-10 h-3/4">
      <div className="h-full bg-gray-100 flex flex-col justify-center items-center shadow-red-400 shadow-lg">
        <h1 className={`mt-5 font-Fahkwang text-lg text-red-600`}>{props.model}</h1>
        <h1 className=" text-4xl font-Prosto">{props.brand}</h1>
        <img className=" w-11/12 h-2/5" src={imageApi + props.image} />
        <div className="grid grid-cols-4">
          <div className=" flex items-center">
            <div className=" flex flex-col mr-4 pl-2">
          ...
          <div className=" flex items-center justify-center">
            <div className=" flex flex-col mr-4">
              <h1 className="font-Pro text-center">Speed</h1>
